...
export default function Home() {
  ...
  useEffect(() => {
    ...
    return onAuthStateChanged(auth, (nextUser) => {
      ...
      setAuthReady(true);
      if (nextUser) {
        if (window.location.hash.startsWith("#social-post-") || window.location.hash.startsWith("#social-session-")) setActiveTab("social");
  ...
  return (
    <main className={`shell ${settingsOpen || notificationsOpen || calendarOpen ? "utility-page-open" : ""} ${workspaceGroup || viewedGroup ? "detail-page-open" : ""} ${rankingGame ? "ranking-page-open" : ""}`}>
      ...
      {activeTab === "games" && <section className="page-view games-page">
        ...
        {activityLoading && <TennisBallLoader label="Refreshing games" />}
