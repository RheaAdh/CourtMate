  ...
  return (
    <main className={`shell ${settingsOpen || notificationsOpen || howItWorksOpen || calendarOpen || connectionsOpen || cmrDetailsOpen ? "utility-page-open" : ""} ${workspaceGroup || viewedGroup ? "detail-page-open" : ""} ${rankingGame ? "ranking-page-open" : ""}`}>
      ...
      {howItWorksOpen && user && <section className="utility-page how-it-works-page" aria-labelledby="how-it-works-title">
        <div className="utility-page-header"><button className="utility-back-button" type="button" onClick={closeUtilityPage} aria-label="Go back">←</button><div><span className="kicker">THE COURTMATE LOOP</span><h1 id="how-it-works-title">How it works</h1><p>From “I want to play” to your sport CMR.</p></div></div>
        ...
        <div className="how-it-works-grid" aria-label="CourtMate game journey">
          ...
          <section className="how-it-works-cmr"><span>04</span><h2>Build your CMR</h2><p>Player feedback grows each sport rating.</p></section>
        </div>
